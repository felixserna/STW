...
<%@page import="demo.ejb.CarritoBean"%>
...
<%
    ...
    if (carrito==null){
        ...
        try {
            // podría accederse mediante un interfaz local
            carrito = (CarritoBean)ic.lookup("java:global/webCarritoLocal/CarritoBean");
